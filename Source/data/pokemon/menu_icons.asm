MonPartyData:
	...
	db ICON_MEW           ; Mew
	db ICON_HATTREM       ; Hattrem
	db ICON_NULL          ; Skitty
	db ICON_NULL          ; Delcatty
	db ICON_NULL          ; Mawile
	db ICON_NULL          ; Swirlix
	db ICON_NULL          ; Slurpuff
