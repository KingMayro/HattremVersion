...
BrutalSwingAnim:
	battle_anim BRUTAL_SWING, SE_MOVE_MON_HORIZONTALLY
	battle_anim NO_MOVE, SE_DARK_SCREEN_FLASH
	battle_anim NO_MOVE, SE_DELAY_ANIMATION_10
	battle_anim NO_MOVE, SE_DARK_SCREEN_FLASH
	battle_anim NO_MOVE, SE_RESET_MON_POSITION
...
DisarmVoiceAnim:
	battle_anim DISARM_VOICE, SE_DARK_SCREEN_FLASH
	battle_anim NO_MOVE, SE_SHAKE_SCREEN
	db -1 ; end

PlayNiceAnim:
	battle_anim PLAY_NICE, SE_SHAKE_BACK_AND_FORTH
	battle_anim NO_MOVE, SE_DELAY_ANIMATION_10
	battle_anim NO_MOVE, SE_RESET_MON_POSITION
	db -1 ; end

LifeDewAnim:
	battle_anim LIFE_DEW, SE_WATER_DROPLETS_EVERYWHERE
	battle_anim NO_MOVE, SE_DELAY_ANIMATION_10
	db -1 ; end

DazzGleamAnim:	
	battle_anim DAZZ_GLEAM, SE_DARK_SCREEN_FLASH
	battle_anim NO_MOVE, SE_DELAY_ANIMATION_10
	battle_anim NO_MOVE, SE_DARK_SCREEN_FLASH
	db -1 ; end

CalmMindAnim:	
	battle_anim CALM_MIND, SE_SPIRAL_BALLS_INWARD
	db -1 ; end

DrainingKissAnim:
	battle_anim DRAIN_KISS, SE_MOVE_MON_HORIZONTALLY
	battle_anim NO_MOVE, SE_DARK_SCREEN_FLASH
	battle_anim NO_MOVE, SE_DELAY_ANIMATION_10
	battle_anim NO_MOVE, SE_SPIRAL_BALLS_INWARD
	db -1 ; end
