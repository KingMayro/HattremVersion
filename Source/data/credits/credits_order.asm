...
; commands that are used to go to the next set of credits texts.
	...
	db CRED_HVERSION, CRED_MAYRO, CRED_TEXT_FADE_MON
	db CRED_MONMENU, CRED_EMERALD, CRED_CHAMBER, CRED_TEXT_FADE_MON
	db CRED_HATVOICE, CRED_MEGGO, CRED_TEXT_FADE_MON
	db CRED_THANKS, CRED_PRET, CRED_TEXT_FADE_MON
