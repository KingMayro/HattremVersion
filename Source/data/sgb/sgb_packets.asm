...
PalPacket_PartyMenu:      PAL_SET PAL_PURPLEMON, PAL_GREENBAR, PAL_YELLOWBAR, PAL_REDBAR
...
PalPacket_Titlescreen:    PAL_SET PAL_LOGO2, PAL_HATTREM, PAL_HATTREM, PAL_PURPLEMON
PalPacket_TrainerCard:    PAL_SET PAL_MEWMON, PAL_BADGE, PAL_REDMON, PAL_YELLOWMON
PalPacket_Generic:        PAL_SET PAL_HATTREM, 0, 0, 0
